...
∇chk_book←handle ctrgl_chk_book args;company;period;jrnl;acct_no;hd;bd;data;coname;width
  ...
  chk_book ← ctrgl_chk_book_init company period jrnl acct_no
  hd←handle ctrgl_chk_heads company period jrnl
  bd←handle ctrgl_chk_bodies hd[;1]
  data←acct_no ctrgl_chk_book_data cth ctrgl_chk_list hd bd
  data←((width←(¯1↑⍴data))↑cth ctrgl_chk_book_begin company period acct_no),[1]data
  data[;7]←+\-/data[;5 6]
...
∇chk_book←cth ctrgl_chk_book_init args;company;period;jrnl;acct_no
  ⍝ Function returns a new check book instance.  The right argument is
  ⍝ a vector of company, period, account number, and jrnl.
  company ← 1⊃ args ◊ period ← 2⊃ args ◊ jrn←3⊃args ◊ acct_no←4⊃args
  ...
  chk_book ← chk_book lex∆assign 'journal' jrn
  chk_book ← chk_book wp∆setData (¯2↑1 1,⍴ctrgl_chk_cols)⍴ctrgl_chk_cols
∇

∇ln←handle ctrgl_chk_book_begin args;co;pd;acct;cmd;name
...
∇ data←old ctrgl_chk_book_add line;ix
